    ...
    <div className="body">
      <div className="filter justify-center flex">
        ...
        <div className="m-4 p-4">
          <input
            type="text"
            className="border border-solid border-black rounded-lg h-8 p-2"
            value={searchText}
            onChange={(e) => {
        ...
        <div className="m-4 p-4 flex items-center">
          <button
            className=" px-4 py-1.5 bg-gray-700 text-white rounded-lg cursor-pointer hover:bg-gray-300 hover:text-black font-medium m-4"
            onClick={() => {
        ...
        <div className="search m-4 p-4 flex items-center font-normal">
          ...
          <input
            className="m-2 border border-black rounded-lg h-8 p-2"
            value={loggedInUser}
